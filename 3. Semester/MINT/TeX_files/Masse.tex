...
\begin{definition}[Maß]
	Ein \begriff{Maß} $\mu$ ist eine Abbildung $\mu: \mathcal{A} \to [0,\infty]$ mit folgenden Eigenschaften:
	\begin{itemize}
	...
	\end{itemize}
	Gilt für $\mu: \mathcal{A} \to [0,\infty]$ nur $(M_1),(M_2)$, dann heißt $\mu$ \begriff{Prämaß}.
\end{definition}
...
\begin{definition}
	\begin{itemize}
		\item Es sei $\mathcal{A}$ eine $\sigma$-Algebra auf $E$ und $\mu$ ein Maß. Dann heißt $(E,\mathcal{A})$ \begriff{Messraum} und $(E,\mathcal{A},\mu)$.
		\item Ein Maß mit $\mu(E) < \infty$ heißt \begriff{endliches Maß} und $(E,\mathcal{A},\mu)$ \begriff{endlicher Maßraum}.
		...
		\item Gibt es eine Folge $(A_n)_{n\in \natur} \subset \mathcal{A}$, sodass $A_n \uparrow E$ und $\mu(A_n) < \infty$, dann heißen $\mu$ und $(E,\mathcal{A},\mu)$ \begriff{$\sigma$-endlich}.
	\end{itemize}
\end{definition}
...
\begin{example}
	\begin{enumerate}
		\item (\begriff{Dirac-Maß}). Es sei $(E,\mathcal{A})$ ein beliebiger Messraum und $x \in E$ fest. Dann ist
		\begin{align}
		...
		\item Es sei $E=\real$ und $\mathcal{A}$ wie in Beispiel 2.3 e) %TODO set reference, once chap 2 has been typed!
...
%		\item Es sei $(E, \mathcal{A})$ ein beliebiger Messraum. Dann ist
%		\begin{align}
