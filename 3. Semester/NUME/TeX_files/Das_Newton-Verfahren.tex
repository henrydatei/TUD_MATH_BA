...
Die Konvergenz der Folge $\{x^k\}$ gegen $x^\ast$ zusammen mit der Eigenschaft \cref{5.3} wird als \begriff{quadratische Konvergenz} der Folge $\{x^k\}$ gegen $x^\ast$ bezeichnet.