...
\begin{remark}
	...
	\begin{itemize}
		...
		\end{align}
		mit einer Nullfolge $\{q_k\}\subset[0,1)$. Speziell lassen sich in diesem Rahmen Verfahren analysieren, bei denen etwa $F'(x ^k)$ durch eine Differenzapproximation ersetzt wird oder das lineare Gleichungssystem des \person{Newton}-Verfahrens nur näherungsweise gelöst wird.
	\end{itemize}
\end{remark}
