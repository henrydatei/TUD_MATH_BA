...
\begin{definition}[Primideal und maximal Ideal]
	Sei $I\unlhd R$.
	\begin{enumerate}[label=(\alph*)]
...
\end{proposition}
\begin{proof}
	Lemma von Zorn. Die Vereinigung einer Kette echter Ideale ist wegen \propref{2_2_3}c) wieder ein echtes Ideal.
\end{proof}