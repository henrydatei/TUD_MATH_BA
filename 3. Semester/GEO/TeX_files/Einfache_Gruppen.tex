...
\begin{proof}
	Sei $\sigma \in A_n$. Schreibe $\sigma=\tau_1 \dots tau_{2r}$ mit Transpositionen $\tau_1,\dots,\tau_{2r} \in S_n$ (siehe \propref{1_1_11}). Es genügt zu zeigen, dass $\tau_1\tau_2$ Produkt ist von $3$-Zykeln ohne Einschränkung sei $\tau_1=(12)$.
	\begin{itemize}
...
\begin{remark}
	\begin{enumerate}
		\item Man kann zeigen, dass es keine nicht zyklische einfachen Gruppen der Ordnung $\#G <\#A_5 = 60$ gibt! (Kann mit den Sylow-Sätzen (\propref{1_8_6}) gezeigt werden oder mit \person{Burnside}'s Lemma, welches wir in dieser Vorlesung nicht behandelt haben.)
