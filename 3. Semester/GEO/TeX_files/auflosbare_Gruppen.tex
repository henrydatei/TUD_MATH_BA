...
\begin{remark}
	\begin{enumerate}
		...
		Genau dann ist $G_{i-1}/G_i$ einfach, wenn es kein $G_{i-1} \gneq N \gneq G_i$ mit $N \unrhd G_{i-1}$ gibt. Das heißt, genau dann ist eine Normalreihe eine Kompositionsreihe, wenn alle ihre Faktoren einfach sind. % different to the lecutre notes, taken from the online version, because fehm avoided using the negation of the normal subgroup symbol!
