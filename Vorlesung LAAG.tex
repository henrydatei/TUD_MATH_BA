...
\section{Vektorräume}
	...
	\subsection{Basis und Dimension}
		...
		alle gleich 0, mit $\lambda\cdot x+\sum\limits_{i \inn I} \lambda_i\cdot x_i=0$. Da $(x_i)$ linear abhängig ist, 
		muss $\lambda \neq 0$ sein, woraus der Widerspruch $x=\lambda^{-1}\cdot\sum\limits_{i \inn I} \lambda_i\cdot x_i
