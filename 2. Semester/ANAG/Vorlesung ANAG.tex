...
\newcommand*{\propref}[1]{%
	...
	{%
		...
		\cref@gettype{#1}{\propositionref@current@type@temp}%get the environment's name
		...
		{%otherwise
			...
			\crefformat{\propositionref@current@type@temp}{%
				\csname cref@\propositionref@current@type@temp @name\endcsname ~##2\rom{\zref@extractdefault{#1@chapter}{default}{1}}.##1##3%
			}%
			\ifmmode 
				\cref{#1}%
			\else
			...
			\fi
			\crefformat{\propositionref@current@type@temp}{%
				\csname cref@\propositionref@current@type@temp @name\endcsname~##2##1##3%
			}%
		}%
	}%
