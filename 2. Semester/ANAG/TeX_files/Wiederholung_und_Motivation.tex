...
\begin{*anmerkung}
	Eine Approximation besitzt zwangsläufig immer einen Fehler. Eine gute Approximation zeichnet sich dadurch aus, dass der Fehler bzw. Rest möglichst klein wird. Dieser Fehler wird mit \person{Landau}-Symbolen beschrieben.
\end{*anmerkung}
...
\begin{example}[gute Approximation durch konstante Funktion nahe $x=x_0$]
	...
	\begin{center}\begin{tikzpicture}
		...
		\addplot+[mark=none, dashed] {x^2-2};
		\addlegendentry{$r$}
		\end{axis}
