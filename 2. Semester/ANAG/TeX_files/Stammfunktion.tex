...
\begin{*definition}[Stammfunktion, unbestimmtes Integral]
	$F: D\subset K^n\to K^m$ heißt \begriff{Stammfunktion} oder \emph{unbestimmtes} \begriff{Integral}[!unbestimmt] von $f$ auf $D$, falls $F$ \gls{differenzierbar} und $F'(x) = f(x)$ $\forall x\in D$
\end{*definition}
