...
\input{./TeX_files/Abbildungen}
\input{./TeX_files/Gruppen}
\input{./TeX_files/Ringe}
\input{./TeX_files/Koerper}
\input{./TeX_files/Polynome}

\chapter{Vektorräume}
\input{./TeX_files/Definition_und_Beispiele}
\input{./TeX_files/Linearkombinationen}
\input{./TeX_files/Basis_und_Dimension}
\input{./TeX_files/Summen_von_VR}

\chapter{Lineare Abbildungen}
\input{./TeX_files/Matrizen}
\input{./TeX_files/Homomorphismen_von_Gruppen}
\input{./TeX_files/Homomorphismen_von_Ringen}
\input{./TeX_files/Homomorphismen_von_VR}
\input{./TeX_files/Der_VR_der_linearen_Abbildungen}
\input{./TeX_files/Koordinatendarstellung_linearer_Abbildungen}
\input{./TeX_files/Quotientenraeume}
\input{./TeX_files/Rang}
\input{./TeX_files/Lineare_Gleichungssysteme}

\chapter{Determinanten}
\input{./TeX_files/Das_Vorzeichen_einer_Permutation}
\input{./TeX_files/Determinante_einer_Matrix}
\input{./TeX_files/Minoren}
\input{./TeX_files/Determinante_und_Spur_von_Endomorphismen}

\chapter{Endomorphismen}
\input{./TeX_files/Eigenwerte}
\input{./TeX_files/Das_charakteristische_Polynom}
\input{./TeX_files/Diagonalisierbarkeit}
\input{./TeX_files/Trigonalisierbarkeit}
\input{./TeX_files/Das_Minimalpolynom}
\input{./TeX_files/Nilpotente_Endomorphismen}
\input{./TeX_files/Die_Jordan_Normalform}

\chapter{Skalarprodukte}
\input{./TeX_files/Das_Standardskalarprodukt}
\input{./TeX_files/Bilinearformen_und_Sesquilinearformen}
\input{./TeX_files/Euklidische_und_unitaere_VR}
\input{./TeX_files/Orthogonalitaet}
\input{./TeX_files/Orthogonale_und_unitaere_Endomorphismen}
\input{./TeX_files/Selbstadjungierte_Endomorphismen}
\input{./TeX_files/Hauptachsentransformation}
\input{./TeX_files/Quadriken}

\chapter{Dualität}
\input{./TeX_files/Das_Lemma_von_Zorn}
\input{./TeX_files/Der_Dualraum}
\input{./TeX_files/Die_duale_Abbildung}
\input{./TeX_files/Die_adjungierte_Abbildung}
\input{./TeX_files/Der_Spektralsatz}
\input{./TeX_files/Tensorprodukte}

\chapter{Moduln}
\input{./TeX_files/Moduln}
\input{./TeX_files/Teilbarkeit}
\input{./TeX_files/Hauptidealringe}
\input{./TeX_files/Faktorielle_Ringe}
\input{./TeX_files/Quotienten_von_Ringen_und_Moduln}
\input{./TeX_files/Der_Elementarteilersatz}
\input{./TeX_files/Zyklische_Vektorraeume}
