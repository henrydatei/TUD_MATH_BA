...
\end{conclusion}
\begin{proof}
	Sei $A=M_B(s)$. Nach \propref{2_7_1} gibt es $S\in\Uni_n(K)$ mit $S^*AS$ eine reelle Diagonalmatrix. Da $S^*=S^{-1}$ haben $A$ und $S^*AS$ die selben Eigenwerte. Bringt man $S^*AS$ nun in die Form in \propref{2_7_5}, so ändern sich die Vorzeichen der Diagonale nicht mehr.
\end{proof}