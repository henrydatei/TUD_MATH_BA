...
\begin{definition}[Bilinearform, Sesquilinearform]
	...
	\begin{itemize}
		...
		\item Für $x,y\in V$, $\lambda\in K$ ist $s(x,\lambda y)=\color{red}\overline{\lambda} s(x,y)$
	\end{itemize}
\end{definition}
...
\begin{definition}
	Sei $s$ eine SLF auf $V$ und $B=(v_1,...,v_n)$ eine Basis von $V$. Die \begriff[Sesquilinearform!]{darstellende Matrix} von $s$ bzgl. $B$ ist
	\begin{align}
