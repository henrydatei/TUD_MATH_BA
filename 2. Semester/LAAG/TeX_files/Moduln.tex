...
\end{proposition}
\begin{proof}
	klar, siehe LAAG 1 III.5.1 %TODO: Verlinkung
\end{proof}
...
\end{proposition}
\begin{proof}
	$M[a]$ ist der Kern des Endomorphismus $x\mapsto ax$ (\propref{4_1_6}), somit ein Untermodul (\propref{4_1_8}).  Seien $a,b\in R\backslash\{0\}$ und $x\in M[a]$, $y\in M[b]$. Ist $R$ nullteilerfrei so ist $ab\neq 0$ und 
	\begin{align}
