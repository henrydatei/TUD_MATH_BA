...
\begin{definition}[freie Familie]
	Eine Familie $(x_i)_{i\in I}$ in $M$ ist \begriff{frei} oder ($R$-linear unabhängig), wenn es keine Familie $(\lambda_i)_{i\in I}$ von Elementen von $R$, fast alle gleich 0, aber nicht alle gleich 0, mit $\sum_{i\in I} \lambda_ix_i=0$ gibt.
	
	Ein freies Erzeugendensystem ... %TODO
\end{definition}