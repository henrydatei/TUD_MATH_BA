...
\NewDocumentCommand{\kringel}{o m m}{%
	\def\@kringel@color{%
		\IfValueTF{#1}{#1}{blue}%
	}
%
	...
	\fi
%
	\settoheight{\contentheight}{\@kringel@inner{#3}}
	\settowidth{\contentwidth}{\@kringel@inner{#3}}
%
	\@kringel@outer{-0.5em}{\begin{tcolorbox}[colframe=blue,halign=center,valign=center,width=1.5\contentwidth,height=2\contentheight,left=0pt,right=0pt,bottom=0pt,top=0pt,boxrule=0.8pt,colback=#2,boxsep=0pt,bean arc]
		\@kringel@inner{#3}
	\end{tcolorbox}}
}
