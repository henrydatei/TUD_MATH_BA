...
\begin{proof}
	...
	\end{enumerate}
\end{proof}
%TODO create cd for the convergence structure ... see eric!
%Hier fehlt die Übersicht, kann man eventuell mit tikzcd erstellen, aber keine Lust im Moment! ;)
%\begin{tikzcd}
%	f.s. - Konvergenz & \arrow[dd, Rightarrow]\arrow[ll, dashed] & & $\Ln{p}$-Konvergenz\\
%	& & &\\
%	stoch Konvergenz & \arrow[d, Rightarrow]\arrow[ll, Leftarrow]& & $\Ln{1}$-Konvergenz\\
%	Verteilungsfunktion
%\end{tikzcd}
