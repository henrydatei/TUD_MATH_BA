...
Oft interessieren wir uns gar nicht für das konkrete Ergebnis des Zufallsexperiments, sondern nur für das Eintreten gewisser Ereignisse.
\begin{*example}
	\begin{itemize}
...
\begin{proposition}[Konstruktion von Wahrscheinlichkeitsmaßen durch Dichten]
	\proplbl{1_8}
	Sei $(\Omega, \sigF)$ ein Ereignisraum.
	\begin{itemize}
...
\begin{*remark}
	\begin{itemize}
		...
		\item Mittels Dirac-Maß $\delta_{x}$ können auch jedes diskrete Wahrscheinlichkeitsmaß auf $\Omega \subset \Rn$ als Wahrscheinlichkeitsmaß auf $\Rn, \mathscr{B}(\Rn)$ interpretieren
		\begin{align}
...
\begin{proof}
	$\nearrow$ \person{Schiling} MINT, Satz 4.5.
\end{proof}
