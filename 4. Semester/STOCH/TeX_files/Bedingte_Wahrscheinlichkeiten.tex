...
\begin{proof}
	Offenbar erfüllt $\P_{B}$ wie definiert \eqref{Renorm} und \eqref{Prop}. Umgekehrt erfüllt $\P$ \eqref{Renorm} und \eqref{Prop}. Dann folgt für $A \in \F$: %TODO @ Umgekehrt there needs to be \P instead of \P_B, otherwise the sentence makes no sense, this was wrong in the lecture and it is also used in the following equation.
	\begin{align}
...
\begin{proof}
	\begin{enumerate}
		\item Es gilt:
		\begin{align*}
			\sum_{i\in I} \P(A\mid B_i)\P(B_i) \defeq \sum_{i\in I}\frac{\P(A \cap B_i)}{\cancel{\P(B_i)}}\cancel{\P(B_i)} = \sum_{i\in I} \P(A \cap B_i) \overset{\sigma-Add.}{=} \P(A)
		\end{align*}
		\item 
		\begin{align*}
