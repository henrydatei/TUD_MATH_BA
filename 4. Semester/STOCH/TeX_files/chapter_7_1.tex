...
\begin{*remark}
	...
	\begin{align*}
%		\E[X] &= \frac{1}{\sqrt{2\pi \sigma^2}} \int_{\R} x e^{-\frac{(x-\mu)^2}{2\sigma^2}}\quad y = \frac{x-\mu}{\sqrt{\sigma^2}}\\
%		&= \frac{1}{\sqrt{2\pi}} \int_{\R} (\sqrt{\sigma^2}y + \mu)e^{-\frac{y^2}{2}} \d y\\
%		&= \sqrt{\frac{\sigma^2}{2\pi}} \underbrace{\int_{\R} y e^{-\frac{y^2}{2}}\dy}_{=0, \text{ Symmetrie}} + \frac{1}{\sqrt{2\pi}}\mu \underbrace{\int_{\R} e^{-\frac{y^2}{2}}\d y}_{\sqrt{2\pi}} = \mu
	\end{align*}
	\begin{align*}
