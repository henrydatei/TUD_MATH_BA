...
Unter der Voraussetzung der Durchführbarkeit bricht \propref{algorithmus_2_11} nach höchstens $n$ Schritten mit der Lösung $x^\ast$ von $Ax=b$ ab, da $\mathcal{L}_n=\Rn$ und $b-Ax^n\perp\mathcal{L}$ somit $b-Ax^n=0$ impliziert.
