...
\begin{definition}[reintranszendent]
	$L \mid K$ \begriff{reintranszendent} $:\equiv L = K(\Halb) \mit \Halb = (a_i)_{i\in I}$ algebraisch unabhängig über $K$.
\end{definition}
\begin{lemma}
	\proplbl{1_5_4}
...
\end{proposition}
\begin{proof}
	Nach \propref{1_5_4} o.E. $L = K(X_i :\colon i \in I)$. Weiter o. E. $I = \set{1, \dots,n}$ endlich. Sei $\alpha \in L$ algebraisch über $K$. Definiere $f = \MinPol(\alpha \mid K)$.\\
