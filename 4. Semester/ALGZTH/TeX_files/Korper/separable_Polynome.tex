...
\begin{example}
	\begin{expenum}
		\item \label{1:6:12:a} $\chara(K) = 0 \implies K$ ist vollkommen
...
\begin{remark}
	\begin{remarkenum}
		\item \label{1:6:13:a} Da $\Phi_p \in \End(K) $ ist $K^p$ ein Teilkörper von $K$ und $\Phi_p$ ist injektiv.
		\item Insbesondere gibt es zu jedem $a \in K$ ein eindeutig bestimmtes $a^{\frac{1}{p}} \in \bar{K}$ mit
		\begin{flalign*}
			\qquad & \Phi_p\Big(a^{\frac{1}{p}}\Big) = \Big(a^{\frac{1}{p}}\Big)^p = a &
		\end{flalign*}
