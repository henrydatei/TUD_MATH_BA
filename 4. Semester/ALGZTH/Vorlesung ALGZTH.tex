...
\include{./TeX_files/Korper/separable_Polynome}
\include{./TeX_files/Korper/separable_Erweiterungen}
\include{./TeX_files/Korper/Norm_Spur}
\include{./TeX_files/Korper/Einfache_Erweiterung}

\chapter{Galoistheorie}
\input{./TeX_files/Galois/Normale_Korpererweiterungen}
\include{./TeX_files/Galois/Hauptsatz_der_Galoistheorie}
\include{./TeX_files/Galois/Endliche_Koerper}
\include{./TeX_files/Galois/Fundamentalsatz_der_Algebra}
\include{./TeX_files/Galois/Das_allgemeine_Polynom}
\include{./TeX_files/Galois/Kreisteilungskoerper}
\include{./TeX_files/Galois/Zyklische_Erweiterungen}
\include{./TeX_files/Galois/Aufloesbarkeit_von_Gleichungen}
\include{./TeX_files/Galois/Konstruktion_mit_Zirkel_und_Lineal}
